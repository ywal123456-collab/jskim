...
const titleId = 'create-item-dialog-title';
...
<template>
  <div class="create-screen-dialog-overlay" @click.self="onOverlayClick">
    ...
    >
      <h2 :id="titleId" class="create-screen-dialog__title">項目を追加</h2>
      ...
      <form class="create-screen-dialog__form" @submit.prevent="onSubmit">
        ...
        <p class="spec-field__hint">
          項目IDは作成後に変更できません。実装時の
          <code>data-jskim-spec-item</code>
          と同じIDを使用すると、自動的に連携できます。
        </p>
        ...
        <label class="spec-field">
          ...
          <input
            ...
            autocomplete="off"
            placeholder="例: text / textarea / button"
          />
          <span
