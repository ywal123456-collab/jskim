...
- Feature Group / ローカル版管理（Phase **7E-1〜7E-5**: domain + CLI + Revision API + Viewer Feature 管理。設計: [local-version-control.md](./local-version-control.md)）
...
12. ~~画面中心 Feature Group + ローカル版管理（Phase 7E-1〜5）~~
...
| `local-version-control.md` | 画面中心モデル・Feature Group・ローカル版管理（7E-1〜7E-5: domain + CLI + Revision API + Feature 管理 実装済み） |
