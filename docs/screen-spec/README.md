...
- Feature Group / ローカル版管理 domain（Phase **7E-1〜7E-3 実装済み**・CLI/UI/Revision API 未提供。設計: [local-version-control.md](./local-version-control.md)）
...
| `local-version-control.md` | 画面中心モデル・Feature Group・ローカル版管理（7E-1〜7E-3 domain 実装済み / CLI・UI 未提供） |
