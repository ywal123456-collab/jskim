...
- Feature Group / ローカル版管理（Phase **7E-1〜7E-4B**: domain + CLI + read-only Revision API / Viewer 改訂履歴。設計: [local-version-control.md](./local-version-control.md)）
...
| `local-version-control.md` | 画面中心モデル・Feature Group・ローカル版管理（7E-1〜7E-4B: domain + CLI + Revision API / 改訂履歴 実装済み） |
