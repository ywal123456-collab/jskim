...
### 実装済み（phase 7C-2A-1 / 7C-2A-2 Reference Image）
...
- **未実装:** Viewer 参照タブ / upload·replace·delete Dialog / runtime polling UI

### 未実装（v1 非範囲を含む）

- 自動再収集 / batch 収集 / Reference Image **Viewer UI** / Figma / visual diff / annotation / viewport config
