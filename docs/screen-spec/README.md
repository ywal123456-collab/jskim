...
### 実装済み（phase 7C-2A-1 Reference Image core）
...
- **未実装:** multipart upload API、runtime uploading/deleting、Viewer 参照タブ / Dialog

### 未実装（v1 非範囲を含む）

- 自動再収集 / batch 収集 / Reference Image **HTTP API・Viewer UI** / Figma / visual diff / annotation / viewport config
